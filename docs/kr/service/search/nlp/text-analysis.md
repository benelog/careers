---
description: 긴 글과 짧은 검색쿼리에서 정보를 추출하고 분석하여, 검색 뿐만 아니라 다양한 기술 및 서비스들에 활용되는 NLP 기반 기술 연구
---
...
![](/assets/kr/image%20(75).png)

## 문서 요약 (Text Summarization)

사용자의 정보 이해 편의를 위하여 문장의 핵심내용으로 요약.

![쇼핑 리뷰 한줄 요약 프로세스 구성도](/assets/kr/image%20(110).png)

...
* CV(Computer vision) 및 NLP(Natural Language Processing) 기술 전반에 대한 연구
* OCR (Optical Character Recognition) 기술 및 문서 이미지 분석 기술 개발
* Image에서 Information Extraction과 Semantic Parsing등 문서 인식 기술 개발
* Vision/Language 관련 대규모 사전학습 언어 모델 개발
* 얼굴 검출 및 인식 관련 모델 및 관련 디바이스 개발
...
* 시각 데이터로부터 의미있는 정보를 추출하는 Vision 기술 연구 개발
* 이미지에서 문자의 검출/인식 및 문서의 구조/의미를 파악하는 기술 연구 개발
* 얼굴 인식을 비롯한 다양한 Computer vision / ML 모델 연구 개발
* 이미지/비디오 관련 서비스를 위한 AI 모델 개발
...
* ML resarcher/engineer/practitioner 관련 실무 경험을 보유
